...
//    private int mConnectionLostCount;
    ...
    public static final int PPRESS_UP = 6;
    public static final int RELSEASE_UP = 7;
    public static final int PPRESS_DOWN = 8;
    public static final int RELSEASE_DOWN =9;
    public static final int PPRESS_RIGHT = 10;
    public static final int RELSEASE_RIGHT = 11;
    public static final int PPRESS_LEFT = 12;
    public static final int RELSEASE_LEFT = 13;
